  ...
  return (
    ...
    <div className='payment-page'>
       <div className='timer-amount'>
           <div>
              <FaRegClock style={{color:'#FC790D',height:'20px',width:'20px'}} />
              <p>{String(minutes).padStart(2, '0')}:{String(seconds).padStart(2, '0')}  <span>Left to complete the booking</span></p>
           </div>
           <div>
       ...
       <div className='upi-card'>
            ...
            <div className='upi-card-tab'>
                <div className={activeTab === "upi"? "active-payment-tab": ""} onClick={()=>setActiveTab("upi")}>
                    <svg style={{height:'30px',width:'30px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 333334 199007" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
                ...
                <div className={activeTab === "card"? "active-payment-tab": ""} onClick={()=>setActiveTab("card")}>
                    <IoCardOutline style={{color:'gray',height:'30px',width:'30px'}} />
                    <div>
            ...
            {activeTab === "upi"?
                <div className='upi'>
                    <div className='text-scanner-upiid'>
                        <div className='upi-text'>
                            <div>
                                <div>
                                    <p>Scan & Pay with UPI</p>
                                    <p>1. Open any UPI or banking app on your phone</p>
                                    <p>2. Scan the QR code to pay</p>
                                </div>

                                <img src='https://images.ixigo.com/image/upload/payment/bdd136fc685170ab2307a63e86d16ca0-trtkp.png' alt='phone-img'/>
                            </div>
                        ...
                        <div className='upi-upiid-seperator'>
                            <div></div>
                            <div><p>OR</p></div>
                            <div></div>
                        </div>
